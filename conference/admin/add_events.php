...
if(isset($_REQUEST['submit'])){
 ...
 if(($_REQUEST['title'] == "") || ($_REQUEST['organiser'] == "") || ($_REQUEST['from_date'] == "") || ($_REQUEST['to_date'] == "") ){
  ...
  $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
   ...
   $fees=$_REQUEST['fees'];
   $sql = "INSERT INTO event(title, organiser, from_date , to_date,  description, link, time , venue,fees, photo) VALUES ('$title' ,'$organiser', '$from_date', '$to_date' ,'$description' , '$link','$time' , '$venue', '$fees' , '$photo')";
...
<div class="col-sm-9 mt-80 mx-3 jumbotron">
  ...
  <form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="text-center">
      ...
      <a href="events.php" class="btn confer-btn mt-4 wow fadeInUp" data-wow-delay="100ms">Close</a>
    </div>
