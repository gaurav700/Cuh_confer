...
session_start();
 ...
 if(isset($_REQUEST['update'])){
  ...
  if(($_REQUEST['title'] == "") || ($_REQUEST['organiser'] == "") || ($_REQUEST['date'] == "")  || ($_REQUEST['time'] == "")){
   // msg displayed if required field missing
   $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill Necessary Fileds </div>';
  } else {
  ...
  $sql = "UPDATE webinar SET  title= '$title', organiser = '$organiser', date = '$date' , time= '$time', description = '$description', link = '$link', venue='$venue' , photo='$photo' WHERE sr_no = '$sr_no'";
...
<div class="col-sm-9 mt-80  mx-3 jumbotron">
  <h3 class="text-center">Update Webinar Details</h3>
  <?php
  ...
  <form action="" method="POST">
   <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="date" class="form-control" id="date" name="date" value="<?php if(isset($row['date'])) {echo $row['date']; }?>">
    </div>
     <div class="form-group">
    ...
    <div class="text-center">
      ...
      <a href="webinar.php" class="btn confer-btn mt-4 wow fadeInUp box" data-wow-delay="100ms">Close</a>
    </div>
