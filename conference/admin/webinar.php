...
<div class="col-sm-9 col-md-10 text-center wow fadeInUp" style="margin-top:120px;">
  <!--Table-->
  <p class=" bg-dark text-white p-2">List of Webinars</p>
  <?php
  ...
  while($row = $result->fetch_assoc()){
   ...
   echo' <div class="single-schedule-area single-page d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
										...
										<form action="edit_webinar.php" method="POST" class="d-inline">
										<input type="hidden" name="id" value='. $row["sr_no"] .'>
...
if(isset($_REQUEST['delete'])){
  $sql = "DELETE FROM webinar WHERE sr_no = {$_REQUEST['id']}";
...
<div><a class="btn btn-success mt-4 wow fadeInUp box" data-wow-delay="100ms" href="add_webinar.php"><i class="fas fa-plus fa-2x"></i></a>
</div>
</div>
