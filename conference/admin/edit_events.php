...
session_start();
 ...
 if(isset($_REQUEST['update'])){
  ...
  if(($_REQUEST['title'] == "") || ($_REQUEST['organiser'] == "") || ($_REQUEST['from_date'] == "") || ($_REQUEST['to_date'] == "") || ($_REQUEST['time'] == "")){
   ...
   $fees=$_REQUEST['fees'];
  $sql = "UPDATE event SET  title= '$title', organiser = '$organiser', from_date = '$from_date', to_date = '$to_date' , time= '$time', description = '$description', link = '$link', venue='$venue',fees='$fees' , photo='$photo' WHERE sr_no = '$sr_no'";
  ...
  <form action="" method="POST">
   <div class="form-group">
    ...
    <div class="text-center">
      ...
      <a href="events.php" class="btn confer-btn mt-4 wow fadeInUp box" data-wow-delay="100ms">Close</a>
    </div>
