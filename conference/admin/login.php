...
<!-- Preloader -->
  ...
  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-user-secret"></i> <span>Admin
      Area</span>
  </p>
    ...
    <div class="row justify-content-center custom-margin">
      <div class="col-sm-6 col-md-4">
        <form action="" class="shadow-lg p-4" method="POST">
         ...
         <button type="submit" class="btn confer-btn mt-10 wow fadeInUp" data-wow-delay="100ms"> Login<i class="zmdi zmdi-long-arrow-right"></i></button>
          <?php if(isset($msg)) {echo $msg; } ?>
        </form>
        <div class="text-center"><a class="btn confer-btn mt-4 wow fadeInDown" data-wow-delay="100ms" href="signup.php">Create New Account</a></div>
      </div>
    </div>
  </div>
