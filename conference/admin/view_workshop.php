...
<div class="col-sm-6 mx-3" style="margin-top:120px;">
 <h3 class="text-center">View Conference Details</h3>
 <?php
 if(isset($_REQUEST['view'])){
  $sql = "SELECT * FROM workshop WHERE sr_no = {$_REQUEST['id']}";
 ...
 <div class="text-center">
  ...
  <form class='d-print-none d-inline' action="workshop.php"><input class='btn btn-secondary' type='submit' value='Close'></form>
 </div>
</div>
